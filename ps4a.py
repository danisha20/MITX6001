...
WORDLIST_FILENAME = "/Users/dannygc/Documents/Documents/MCC/MCCi2/Python/Exercises/6001x/Week 4 Testing and Debugging/ProblemSet4/words.txt"
...
def getWordScore(word, n):
    ...
    if len(word) == n: 
        score += 50
    for i in word: 
        score += SCRABBLE_LETTER_VALUES.get(i) * len(word)
    return score
...
def updateHand(hand, word):
    ...
    for i in newHand.keys(): 
        if i in word:
            newHand[i]-= word.count(i)
    return newHand

#other way 
'''
return(dic((a,b - word.count(a)) for a,b in hand.items())
'''
    ...
    while calculateHandlen(hand) > 0 : 
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                totalScore += score
                print('"' +guess+ '"' + ' earned ' + str(score) + ' points. Total: ' + str(totalScore) + ' points', '\n')
                # Update the hand 
...
''' 
hand = {'h':3, 'p': 2, 'e':1 , 'l': 3, 'o':1}
wordList = ['cat', 'dog', 'hello']
n = 10
